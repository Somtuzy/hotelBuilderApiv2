...
router.route('/users/:id')
    .patch(authenticate_1.default, authorize_1.default, user_controller_1.default.editUser)
    .delete(authenticate_1.default, authorize_1.default, user_controller_1.default.deleteUser)
